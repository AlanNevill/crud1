...
<body>
  ...
  <main role="main" class="container">
    ...
    <!-- Enquiry form -->
    <form id="enquiryForm" class="needs-validation" onsubmit="postEnquiry(event)">
        ...
        <div class="form-row">
          <div class="form-group col-md-6 mb-3">
            ...
            <div class="invalid-feedback">First name appears to be missing or invalid</div>
          </div>
          ...
          <div class="form-group col-md-6 mb-3">
            ...
            <div class="invalid-feedback">Last name appears to be missing or invalid</div>
          </div>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="col-xs-6 ml-auto">
            <p class="text-muted"><strong>*</strong>&nbspThese fields are required.</p>
          </div>
  ...
  <!-- page javascipt -->
  <script src="../js/enquiry2.js"></script>
